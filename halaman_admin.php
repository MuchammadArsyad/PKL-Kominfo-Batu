    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="index.php?module=home"><img src="img/kesbang-logo.png"  width="120"></a></p>
          <h5 class="centered"></h5>
          <br>
		            
		  <li class="">
		  <a class="" href="halaman_admin.php?module=upolad_berkas">
        ...
        ?>
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="index.php?module=home"><img src="img/kesbang-logo.png"  width="100"></a></p>
          ...
          <li class="">
            <a class="" href="halaman_admin.php?module=aktivitas">
              <!-- <i class="fa fa-file"></i> -->
              <span>Aktivitas</span>
              </a>
          </li>
      ...
      <section class="wrapper">
        <div class="row">
          ...
          if ($_GET['module'] == 'aktivitas') {
            include "pages/hasil/list_hasil22.php";
          }
           ?>
